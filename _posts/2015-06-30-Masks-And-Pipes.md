...
According to [**this post**](http://www.cyberciti.biz/tips/understanding-linux-unix-umask-value-usage.html) it is because **_only binaries and scripts are executable, regular files are not_**.
